...
int main() {
  ...
  dense_hash_map<unsigned long int, unsigned long int> paths;
  paths.set_empty_key(NULL);
  paths[3] = 3;

  dense_hash_map<unsigned long int, unsigned int> sqrts;
  sqrts.set_empty_key(NULL);
  sqrts[3] = 0;
